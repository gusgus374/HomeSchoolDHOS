...
ROLES = [None,"Coach Gus", "Addie Owens", "Aiden Poirier", "Alex Poirier", "Ari Parkin", "Ben Stewart", 
         "Bennet Owens", "Bray Inman", "Daniel Stewart", "Easton Ford", "Evan Ortiz", "Hollyn Ford", "Isla Inman",
         "Isla Parkin", "John Wright", "June Wilson", "Layla Ortiz", "Luke Wilson", "Olive Owens", "Tyler Stewart"]
allroles = ["Coach Gus", "Addie Owens", "Aiden Poirier", "Alex Poirier", "Ari Parkin", "Ben Stewart", 
         "Bennet Owens", "Bray Inman", "Daniel Stewart", "Easton Ford", "Evan Ortiz", "Hollyn Ford", "Isla Inman",
         "Isla Parkin", "John Wright", "June Wilson", "Layla Ortiz", "Luke Wilson", "Olive Owens", "Tyler Stewart"]
...
with col2:
      st.page_link("https://footylab.notion.site/Home-School-footyLab-Dick-s-House-of-Sport-17ad64111f0380739f50c10ca4e5f322", label="footyLab Magicians", icon="🧙‍♀️")
